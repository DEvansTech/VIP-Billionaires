    ...
    <NavigationContainer
      ...
      >
        <>
          ...
          {root === ROOT_ADD_INFO ? <Stack.Screen name="UpdateProfileAndBasicInfo" component={UpdateProfileAndBasicInfo} /> : null}
          <Stack.Screen name="About" component={AboutView} options={{ headerShown: true }}/>
